#-----------------------------------------------------------------------------
# This file is part of the 'axi-soc-versal-core'. It is subject to
# the license terms in the LICENSE.txt file found in the top-level directory
# of this distribution and at:
#    https://confluence.slac.stanford.edu/display/ppareg/LICENSE.html.
# No part of the 'axi-soc-versal-core', including this file, may be
...
import axi_soc_versal_core as core

import click
import time

class AxiSocCore(pr.Device):
    """This class maps to axi-soc-versal-core/shared/rtl/AxiSocVersalReg.vhd"""
    def __init__(self,
                 numDmaLanes = 1,
                 sim         = False,
                 **kwargs):
